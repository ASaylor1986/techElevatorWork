...
-- That’s because if the rows don’t exist in both tables, we won’t show any information for it. If we want to show data 
-- FROM the left side table everytime, we can use a different join:
