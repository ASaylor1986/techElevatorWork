...
public class JDBCCityDAOIntegrationTest {
	...
	private static final String TEST_DISTRICT = null;
	...
	private boolean assertCityMatchesTestData(City c) {
		assertEquals("Test City", c.getName());
		assertEquals("Test District", c.getDistrict());
	...
	@Test
	public void update_city_to_match_objects() {
		City newCity = createTestCity();
		dao.create(newCity);
