...
function setPageTitle() {
  ...
  const pageTitle = document.getElementById('page-title'); //the page-title quote is for the h2's id on the page
...
function setPageDescription() {
  document.querySelector('.description').innerText = description; //can't use getElementById on this one
}
...
function displayReviews() {
  ...
  reviews.forEach(review => {
    ...
    // container.setAttribute('class', 'review'); this would erase all of the other classes there, and replace them with review
