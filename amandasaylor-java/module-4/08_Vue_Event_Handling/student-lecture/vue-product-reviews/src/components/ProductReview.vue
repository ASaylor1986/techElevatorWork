<template>
    <div class="main">
        ...
        <div class="well-display" @click:filter = 0>
            <div class="well">
        ...
        <a href="#" v-on:click="showForm = true" v-if="showForm === false">Show Form</a>
        ...
        <form v-if="showForm === true" v-on:submit.prevent="addNewReview">
            ...
            <button type="cancel" v-on:click.prevent="showForm = false">Cancel</button>
        </form>
