...
public class RequestAuthProviderTest {
    ...
    public void hasRoleSuccessTest() {
        ...
        assertTrue(sut.isUserType(new String[] { "user" }));
    }
    ...
    public void hasRoleFailTest() {
        ...
        assertFalse(sut.isUserType(new String[] { "admin" }));
    }
    ...
    public void hasRoleMultipleSuccessTest() {
        ...
        assertTrue(sut.isUserType(new String[] { "admin", "user", "editor" }));
    }
    ...
    public void hasRoleMultipleFailTest() {
        ...
        assertFalse(sut.isUserType(new String[] { "admin", "manager", "editor" }));
    }
    ...
    public void hasRoleNullTest() {
        ...
        assertFalse(sut.isUserType(null));
    }
    ...
    public void hasRoleEmptyTest() {
        ...
        assertFalse(sut.isUserType(new String[] {}));
    }
}